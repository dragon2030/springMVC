...
public class InetAddressMain {
    public static void main(String[] args){
        ...
        new com.bigDragon.javase.ioStream.BIO.InetAddress.TCPTest1();
        //例题2：客户端发送文件给服务端，服务端将文件保存在本地
        new com.bigDragon.javase.ioStream.BIO.InetAddress.TCPTest2();
        //例题3：从客户端发送文件给服务端，服务端保存到本地，并返回“发送成功”给客户端。
        new com.bigDragon.javase.ioStream.BIO.InetAddress.TCPTest3();

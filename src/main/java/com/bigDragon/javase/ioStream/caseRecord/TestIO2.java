...
//        noLineBreak = noLineBreak.replace(" ","");
        ...
        Set<String> splitCmpanySet = new HashSet<>(Arrays.asList(split));
        ...
        for(String subCompany : excludeCmpanySet){
            if(splitCmpanySet.contains(subCompany)){continue;}

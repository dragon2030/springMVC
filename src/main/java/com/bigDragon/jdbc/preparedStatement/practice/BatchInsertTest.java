...
public class BatchInsertTest {
	...
	/**
	 * 	与方式二的对比，就如同io写文件时用char和char[1024]的区别，
	 * 	方式二中，每一次执行ps.execute()都和磁盘交互了一次，一共交互了两万此，而方式三500此一提交
	 */
	/*
	 * 批量插入的方式三：
	...
	//默认情况下，自动提交数据，每次插入（500条数据）executeBatch都会提交一次花费更多时间，可以用手动整体提交的方式，整体一起提交数据
	@Test

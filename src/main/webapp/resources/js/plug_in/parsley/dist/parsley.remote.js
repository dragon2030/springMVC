...
window.ParsleyExtend = $.extend(window.ParsleyExtend, {
  ...
  _asyncIsValidField: function (force, value) {
    ...
    // If com.bigDragon.common.regular isValid (matching com.bigDragon.common.regular constraints) returns `false`, no need to go further
    // Directly reject promise, do not run remote validator and save server load
    if (false === this.isValid(force, value))
      deferred.rejectWith(this);

    // If com.bigDragon.common.regular constraints are valid, and there is a remote validator registered, run it
